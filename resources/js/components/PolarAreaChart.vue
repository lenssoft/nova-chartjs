<template>
    <card class="p-10">
      ...
      <line-chart :chart-data="datacollection" :options="options" :height="card.options && !isNaN(card.options.height) ? card.options.height : 110"></line-chart>
    </card>
</template>
...
<script>
  import LineChart from '../polar-area-chart.js'
